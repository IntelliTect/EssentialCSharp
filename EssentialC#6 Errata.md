...
2           | 38           | Table 2.3: The minimum value of the decimal type should be `Approximately -7.9 × 10^(-28)`. The value `1.0 × 10^(-28)` is instead the smallest representable positive value of the type.
