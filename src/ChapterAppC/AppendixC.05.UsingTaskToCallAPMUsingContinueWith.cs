namespace AddisonWesley.Michaelis.EssentialCSharp.AppendixC.ListingC_05
{
    using System;
    using System.IO;
    using System.Linq;
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
                ...
                urls = new string[]  
          {
            ...
            {
                tasks[line] = DisplayPageSizeAsync(urls[line], line);
            }
            ...
            Task[] tasks)
        {
            for(int i = 0; i < tasks.Length; i++)
            {
                ...
                {
                    DisplayProgress(
                        (WebRequestState)tasks[i].AsyncState);
                }
            }
        }
