...
public class ProductSerialNumberTests
{
    ...
    public void Equals_GivenEqualObjects_Equal()
    {
        ...
        ProductSerialNumber productSerialNumber2 = new("12", 11, 11001);
    ...
    {
        ProductSerialNumber productSerialNumber1 = new(productSeries1, model1, id1);
        ProductSerialNumber productSerialNumber2 = new(productSeries2, model2, id2);
